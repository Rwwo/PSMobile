    ...
    public async Task<Cadastros> ClientesGravarAsync(Cadastros input)
    {
        ...
        try
        {
            var parameters = new[]
            {
                ...
                new NpgsqlParameter("cli_limitetotal", DbType.Decimal) { Value = DBNullOrValue(input.CadastroCliente.CadastroCredito.cad_cli_limitetotal) },
                new NpgsqlParameter("cli_limitemensal", DbType.Decimal) { Value = DBNullOrValue(input.CadastroCliente.CadastroCredito.cad_cli_limitemensal) },
                new NpgsqlParameter("cli_limiteparcelas", DbType.Int32) { Value = DBNullOrValue(input.CadastroCliente.CadastroCredito.cad_cli_limiteparcelas) },
                new NpgsqlParameter("cli_rendacomprovada", DbType.Decimal) { Value = DBNullOrValue(input.CadastroCliente.CadastroCredito.cad_cli_rendacomprovada) },
                new NpgsqlParameter("cli_comprovanterenda", DbType.String) { Value = DBNullOrValue(input.CadastroCliente.CadastroCredito.cad_cli_comprovanterenda) },
                new NpgsqlParameter("cli_renda", DbType.Decimal) { Value = DBNullOrValue(input.CadastroCliente.CadastroCredito.cad_cli_renda) },
                ...
                new NpgsqlParameter("_cad_cli_diastolerancia", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_cli_liberado", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_procli_key", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_cli_desconto", DbType.Decimal) { Value = DBNullOrValue(input.CadastroCliente.CadastroCredito.cad_cli_desconto) },
                new NpgsqlParameter("_cad_cli_codigoextra", DbType.String) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_cli_liberardescontos", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_cli_conv_key", DbType.Int32) { Value = DBNullOrValue(null) },
                ...
                new NpgsqlParameter("_cad_carfid_key", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_indicacaopresenca", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_consumidorfinal", DbType.Int32) { Value = DBNullOrValue(null) },
                ...
                new NpgsqlParameter("_cad_ufsemi_codigo", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_entreferencia", DbType.String) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_cli_ven_fixo", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_tipoissqn", DbType.Int32) { Value = DBNullOrValue(null) },
                ...
                new NpgsqlParameter("_cad_cli_juros", DbType.Decimal) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_cli_naocobrar", DbType.Int32) { Value = DBNullOrValue(null) },
                new NpgsqlParameter("_cad_ieisento", DbType.Int32) { Value = DBNullOrValue(null) }
            };
