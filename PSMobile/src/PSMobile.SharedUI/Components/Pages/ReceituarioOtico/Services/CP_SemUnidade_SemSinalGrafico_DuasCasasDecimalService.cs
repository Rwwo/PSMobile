...
{
    public class CP_SemUnidade_SemSinalGrafico_DuasCasasDecimalService : IStyleService
    {
        public MudTextField<string> From { get; set; }
        public MudTextField<string> To { get; set; }
        public MudTextField<string> TbAdicao { get; set; }

        public CP_SemUnidade_SemSinalGrafico_DuasCasasDecimalService(MudTextField<string> from, MudTextField<string> to, MudTextField<string> tbAdicao)
        {
            From = from;
            To = to;
            TbAdicao = tbAdicao;
