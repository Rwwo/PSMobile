...
{
    public class CP_SemUnidade_ComCasaDecimalSomandoService : IStyleService
    {
        public MudTextField<string> From { get; set; }
        public MudTextField<string> To { get; set; }
        public MudTextField<string> TbAdicao { get; set; }

        public CP_SemUnidade_ComCasaDecimalSomandoService(MudTextField<string> from, MudTextField<string> to, MudTextField<string> tbAdicao)
        {
            From = from;
            To = to;
            TbAdicao = tbAdicao;
        ...
        public void Process()
        {
            ...
            if (VLR_Adicao != "")
            {
                ...
                if (VLR_From != "")
                {
                    To.Text = (VLR_From + VLR_Adicao).ToString();
            ...
            {
                From.Text =  From.FormatarValorTextBox();
            }
