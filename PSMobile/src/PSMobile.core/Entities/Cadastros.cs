...
{
    public string? cad_cli_naturalidade { get; set; }
    public short? cad_cli_exc { get; set; }
    public DateTime? cad_cli_dataexc { get; set; }
    public int cad_cli_usu { get; set; }
    public string? cad_cli_comput { get; set; } = "";
    public DateTime? cad_cli_datamud { get; set; }
    public DateTime? cad_cli_datacad { get; set; }
    public short cad_cli_liberado { get; set; } = 1;
    public int cad_cli_diastolerancia { get; set; }
...
{
    public string? cad_for_suframa { get; set; }
    public int? cad_for_grufor_key { get; set; }
    public short cad_for_creditoicms { get; set; } = 1;
    public short? cad_for_exc { get; set; }
    public DateTime? cad_for_dataexc { get; set; }
    public int cad_for_usu { get; set; }
    public string? cad_for_comput { get; set; } = "";
    public DateTime? cad_for_datamud { get; set; }
    public DateTime? cad_for_datacad { get; set; }
...
public class CadastroTransportadora : BaseEntity
{
    ...
    public DateTime? cad_tra_datamud { get; set; }
    public DateTime? cad_tra_datacad { get; set; }
    public string? cad_rntrc { get; set; }
