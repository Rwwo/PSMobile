...
{
    public static PedidoInputModel ToPedidoInputModel(this Pedidos pedido)
    {
        var ret = new PedidoInputModel
        {
            ...
            PedidoItens = pedido.PedidosItens.ToList(),
            PedidosFormasPagamento = pedido.PedidosFormasPagamento.ToList(),
            Funcionario = pedido.Funcionario,
            Cliente = pedido.Cliente ?? new Cadastros(),
